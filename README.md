...
Changes in develop or master trigger a [GitHub Actions]([https://travis-ci.com/panoptes-organization/panoptes](https://github.com/panoptes-organization/panoptes/actions)) build (and runs tests)
